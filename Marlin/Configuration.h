...
#define STRING_CONFIG_H_AUTHOR "(Magic Dan, Chiron SKR PRO V1.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Imprimante à Magic Dan"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1286.4, 1608, 6399, 2210} 
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_AUTO_INIT  ///dan : pas certain // Init EEPROM automatically on any errors.
